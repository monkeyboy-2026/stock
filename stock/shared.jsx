...
// Children are rendered directly in the flex column; each child is responsible
// for its own scrolling (TabBar can sit at the bottom without scrolling away
// with the content).
function Phone({ children, bg = 'var(--bg)' }) {
  return (
    <div style={{
      width: 390, height: 812, overflow: 'hidden',
...
function TabBar({ tabs, active, onChange = () => {} }) {
  ...
  return (
    <div style={{
      ...
      backdropFilter: 'blur(20px)', padding: '8px 0 22px',
      position: 'relative',
    }}>
      <div
        ref={scrollerRef}
